...
VALUES ('02c72178-bac2-424c-aa38-1c60a2aa1d6e', '添加用户', 'manageUser.create', 'manageUser'),
       ('186c3767-02af-48b8-84a1-24cdabc19961', '启/禁用用户', 'manageUser.changeState', 'manageUser'),
       ('8f8e65b1-968b-4e47-a26f-466ab6e095b8', '删除用户', 'manageUser.delete', 'manageUser'),
       ('cf31e280-1f42-45eb-bd46-a93782168328', '修改用户名称', 'manageUser.changeName', 'manageUser'),

       ('2c9e517f-6edf-4cc9-a5e6-a582a87c3753', '删除分区', 'partition.delete', 'partition'),
       ('2e23a0dc-ecc2-448e-92d5-09d698553d31', '创建分区', 'partition.create', 'partition'),
       ('4be6129d-b3b0-41df-9fcc-946ab36545dc', '编辑分区名称', 'partition.editName', 'partition'),

       ('9916879f-457d-4d66-bc82-5c584d601023', '编辑他人的题目', 'question.editOthers', 'question'),
       ('4d0be824-2e7b-48fa-aba3-a1a37c452e23', '启/禁用题目', 'question.enableDisable', 'question'),
       ('dc64a9e4-2f97-425b-9e8d-6c32c155094f', '创建和修改自己的题目', 'question.createEditOwn', 'question'),
       ('e3398957-89a8-4ac2-960a-0a80599d5da2', '删除他人的题目', 'question.deleteOthers', 'question'),
       ('e49f7e9d-9ff9-4e86-b4a6-d08ecdb353eb', '删除自己的题目', 'question.deleteOwn', 'question'),
       ('fe15070c-3466-4be9-a529-b15918ad34f8', '修改题目作者', 'question.changeAuthor', 'question'),

       ('95d02dee-6597-470a-b362-134ff7e97836', '编辑他人的题组', 'questionGroup.editOthers', 'questionGroup'),
       ('2d9f4b13-aa1a-4dbc-862b-f8908f4573b0', '启/禁用题组', 'questionGroup.enableDisable', 'questionGroup'),
       ('d7bb3cc3-9a28-4302-9d20-2ac55d5188f5', '创建和修改自己的题组', 'questionGroup.createEditOwn','questionGroup'),
       ('8a5955c5-1efa-45a8-b81e-ab48c198f140', '删除他人的题组', 'questionGroup.deleteOthers', 'questionGroup'),
       ('e0f7e540-3a7c-499b-952d-a4785778c6be', '删除自己的题组', 'questionGroup.deleteOwn', 'questionGroup'),
       ('e21f3c78-6139-45b7-b1c5-1245040c1c33', '修改题组作者', 'questionGroup.changeAuthor', 'questionGroup'),

       ('6aa6faef-510b-41b6-a4bc-6ee51a8d19a6', '删除用户组', 'role.delete', 'role'),
       ('9809102d-91a5-4b6e-8a31-1f2ece3500d7', '创建用户组', 'role.create', 'role'),
       ('58bed2fa-ca97-411c-b511-e7bf31a435cc', '修改用户组权限', 'role.editPermission', 'role'),
       ('1692eeda-c00a-4bb2-b176-e109e462d11e', '修改用户组排列等级', 'role.updateLevel', 'role'),
       ('07a13959-7044-4f7c-bf4c-661853871700', '操作用户组 admin', 'role.operateAdmin', 'role'),
       ('67b26d13-8373-4264-ba2a-4d8201ceebb0', '操作用户组 super admin', 'role.operateSuperAdmin', 'role'),
       ('b7d7ca43-7f6c-477f-a861-a14cb9e906dc', '操作用户组 user', 'role.operateUser', 'role'),
       ('cd5ca696-b5ec-46cc-8f31-2752f82ab811', '操作用户组 advanced user', 'role.operateAdvancedUser', 'role'),

       ('9bdc8382-ae40-4320-bad3-73ddb5206848', '获取他人试题记录', 'examData.get', 'examData'),
       ('0eccd16d-5dce-4df8-9f8c-45a7d2df2f31', '获取他人试题提交内容', 'examData.getSubmission', 'examData'),
       ('bbe16951-575d-478c-87d7-06d7dd1c5567', '手动无效化试题', 'examData.manualInvalidExam', 'examData'),

       ('650e15dc-39f5-40d2-b64e-23b7725851d6', '获取请求记录', 'requestRecord.get', 'requestRecord'),

       ('ac3ae336-494d-99fb-599f-80119a039c0d', '修改高级设置', 'setting.saveAdvance', 'setting'),
       ('18a698c5-199a-4ee6-be94-3a9b2b712c59', '修改首页设置', 'setting.saveFacade', 'setting'),
       ('837B1e7d-4f84-4a21-b921-87eb6936f716', '修改生成设置', 'setting.saveGenerating', 'setting'),
       ('9e3bc5cb-2b52-40d1-9131-29b79dd86a78', '修改评分设置', 'setting.saveGrading', 'setting'),
       ('f7cebeB8-df52-41bd-8717-1f469cbe2a4b', '修改校验设置', 'setting.saveVerification', 'setting'),
       ('e7bb795c-5e37-4b32-8cd6-cdf43b55c68a', '获取高级设置', 'setting.getAdvance', 'setting'),
       ('82b8b209-f265-4d5b-8d4d-cf9dd81657b8', '获取生成设置', 'setting.getGenerating', 'setting');
