...
@Action("approveRecalculation")
public class ApproveRecalculationAction extends BaseAction<ApproveRecalculationAction.Input, OutputData> {
    ...
    public ApproveRecalculationAction(ScoreRecalculationService recalculationService) {
    ...
    public void execute(ExecuteContext<Input, OutputData> context) {
        ...
        try {
            recalculationService.approveRecalculation(
